# AngularJS Mango Tutorial Application
...
### CORS setup in Mango
- See the Sysetm Settings page for the mango API module on how to modify override-web.xml to enable the CORS filter.
- Add the header: Access-Control-Allow-Headers	x-requested-with, password
- Add the header: Access-Control-Allow-Origin	http://localhost:8000
