...
alter table controlControllers add constraint controlControllersPk primary key(id);
...
alter table controlAlgorithms add constraint controlAlgorithmsPk primary key(id);
