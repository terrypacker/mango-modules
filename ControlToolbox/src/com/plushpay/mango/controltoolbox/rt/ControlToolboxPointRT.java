 ...
 *
 */
public class ControlToolboxPointRT {
	...
	public ControlToolboxPointRT(ControlToolboxPointVO vo, int vectorIndex){
		this.vo = vo;
	...
	public ControlToolboxPointVO getVo() {
		return vo;
	}
	public void setVo(ControlToolboxPointVO vo) {
		this.vo = vo;
	}
