 ...
 *
 */
public class ControlToolboxSystemOutputPointListener implements DataPointListener{
	 ...
	 * @param pointRT
	 */
	public ControlToolboxSystemOutputPointListener(ControlToolboxControllerRT controller, ControlToolboxPointRT rt) {
	...
	public void pointUpdated(PointValueTime newValue) {
		...
		this.controller.updateSystemOutputs(rt);
	}
