 ...
 *
 */
public class ControlToolboxAlgorithmAuditEventTypeDefinition extends AuditEventTypeDefinition{

	
    public static final String TYPE_NAME = "CT_A";
    ...
    public String getDescriptionKey() {
        return "controltoolbox.event.audit.algorithm.name";
    }
