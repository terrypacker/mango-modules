 ...
 *
 */
public class ControlToolboxControllerAuditEventTypeDefinition extends AuditEventTypeDefinition{

	
    public static final String TYPE_NAME = "NN_N";
    ...
    public String getDescriptionKey() {
        return "neuralnet.event.audit.network.name";
    }
